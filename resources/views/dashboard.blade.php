        ...
        <div class="">
            ...
            <section class="bg-gray-900">
                ...
                <div class="relative px-10">
                    ...
                    <div id="gameCarousel" class="flex overflow-x-auto scroll-smooth mt-4 space-x-4 pb-4 no-scrollbar">
                        @forelse($games as $game)
                            <div
                                class="flex-none w-60 bg-gray-900 border-2 border-purple-800 rounded-lg overflow-hidden hover:scale-105 transform transition duration-300 shadow-lg hover:shadow-[0_0_15px_#9333ea]">
            ...
            <section class="bg-gray-900">
                <div class="flex flex-col items-center justify-center  bg-gray-950 w-full h-32 px-8 py-6">
                    ...
                    <h4 class="text-gray-300 text-[18px] ">Guia de categorias</h4>
                </div>
                ...
                <div class="mt-[10px] justify-center items-center flex mr-[50px] ml-[50px]">
                    <div class="flex  h-[400px] overflow-hidden">
                        ...
                        <a id="openpop1" href="#"
                            class="group relative flex-1 transition-all duration-500 ease-in-out hover:basis-[60%] block">
                            ...
                            <span
                                class="absolute bottom-6 left-6 text-white text-2xl font-bold opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                                Any%
                            </span>
...
{{-- -----------------------------------------------------Pop-up------------------------------------------------------------------ --}}
                ...
                <div id="myModal1" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 hidden">
                    <div
                        class="bg-gray-900 text-white rounded-xl border-purple-700 border-4  shadow-lg w-96 p-6 relative">
                        <h2 class="text-2xl font-bold mb-3 text-purple-600 ">Any%</h2>
                        <p class="text-gray-300 mb-4">A categoria mais popular, que exige apenas que o jogador chegue ao
                            final do jogo o mais rápido possível, utilizando quaisquer estratégias, atalhos ou falhas
                            permitidas pela categoria.</p>
                ...
                <div id="myModal2" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 hidden">
                    <div
                        class="bg-gray-900 text-white border-purple-700 border-4 rounded-xl shadow-lg w-96 p-6 relative">
                        <h2 class="text-2xl font-bold mb-3 text-purple-600 ">100%</h2>
                        <p class="text-gray-300 mb-4">Exige que o jogador complete todo o conteúdo do jogo, como
                            coletar todos os itens ou derrotar todos os chefes, antes de chegar ao final, resultando em
                            speedruns geralmente mais longas.</p>
                ...
                <div id="myModal3" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 hidden">
                    <div
                        ...
                        <p class="text-gray-300 mb-4">O oposto de 100%, onde o objetivo é vencer o jogo completando a
                            menor quantidade possível de objetivos ou coletando o mínimo de itens.</p>
                ...
                <div id="myModal4" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 hidden">
                    <div
                        ...
                        <p class="text-gray-300 mb-4">Uma variação que proíbe o uso de quaisquer falhas (glitches) para
                            avançar pelo jogo, forçando os jogadores a completar o jogo apenas com as mecânicas padrão.
                        </p>
                        <button id="closeModal4"
                            class="absolute top-3 right-3 text-gray-400 hover:text-white text-xl">&times;</button>
                    </div>
                </div>
                ...
                <div id="myModal5" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 hidden">
                    <div
                        ...
                        <p class="text-gray-300 mb-4">é um speedrun que utiliza ferramentas externas, como emuladores,
                            para criar uma jogada "perfeita"</p>
                        <button id="closeModal5"
                            class="absolute top-3 right-3 text-gray-400 hover:text-white text-xl">&times;</button>
                    </div>
                </div>
                ...
                <div id="myModal6" class="fixed inset-0 bg-black/60 flex items-center justify-center z-50 hidden">
                    <div
                        ...
                        <p class="text-gray-300 mb-4">é um speedrun feito por um jogador humano em tempo real, sem a
                            ajuda de ferramentas.</p>
                        <button id="closeModal6"
                            class="absolute top-3 right-3 text-gray-400 hover:text-white text-xl">&times;</button>
                    </div>
                </div>
            </section>
{{-- ---------------------------------------------------------------------------------------------------------------------------- --}}
            <footer>
                <div class="w-full h-100 border-t-2 border-purple-700 bg-gray-950" >
