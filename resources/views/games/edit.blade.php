<x-app-layout>
    ...
    <div class="flex min-h-screen bg-gray-950">
        ...
        <div class="flex flex-col justify-center ml-12 mt-[8px] mb-32">
            <x-application-logo-2 class="w-[100px] h-[100px] ml-[230px] fill-current text-primary" />
                        ...
                        <div>
                            ...
                            <select id="plataforma" name="plataforma" required
                                class="pl-2 w-[260px] h-9 bg-gray-800 border border-primary text-gray-100 rounded-lg 
                                       focus:ring-2 focus:ring-primary focus:border-primary">
                                <option value="PS2"
                                    {{ old('plataforma', $game->plataforma) == 'PS2' ? 'selected' : '' }}>PS2</option>
                                <option value="PS3"
                                    {{ old('plataforma', $game->plataforma) == 'PS3' ? 'selected' : '' }}>PS3</option>
                                <option value="PS4"
                                    {{ old('plataforma', $game->plataforma) == 'PS4' ? 'selected' : '' }}>PS4</option>
                                <option value="PS5"
                                    {{ old('plataforma', $game->plataforma) == 'PS5' ? 'selected' : '' }}>PS5</option>
                                <option value="XBOX ONE"
                                    {{ old('plataforma', $game->plataforma) == 'XBOX ONE' ? 'selected' : '' }}>XBOX ONE
                                </option>
                                <option value="XBOX 360"
                                    {{ old('plataforma', $game->plataforma) == 'XBOX 360' ? 'selected' : '' }}>XBOX 360
                                </option>
                                <option value="XBOX SERIES X|S"
                                    {{ old('plataforma', $game->plataforma) == 'XBOX SERIES X|S' ? 'selected' : '' }}>
                                    XBOX SERIES X|S</option>
                                <option value="NITENDO"
                                    {{ old('plataforma', $game->plataforma) == 'NITENDO' ? 'selected' : '' }}>NITENDO
                                </option>
                                <option value="PC"
                                    {{ old('plataforma', $game->plataforma) == 'PC' ? 'selected' : '' }}>PC</option>
                                <option value="OTHERS"
                                    {{ old('plataforma', $game->plataforma) == 'OTHERS' ? 'selected' : '' }}>OTHERS
                                </option>
                            </select>
                        </div>
