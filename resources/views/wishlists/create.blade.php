<x-app-layout>
    ...
    <div class="flex min-h-screen bg-[#070707]">
        ...
        <div class="hidden md:block bg-center bg-cover w-[1000px] h-[570px] border-r border-primary/40 shadow-2xl"
            ...
            <form action="{{ route('wishlists.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6 text-gray-200">
                ...
                <div>
                    ...
                    <input type="file" id="image" name="image" required
                        class="w-[250px] text-gray-100 bg-gray-900 border border-primary rounded-lg 
                               ...
                               hover:file:bg-primary/30 transition-all duration-200" />
